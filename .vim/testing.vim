...
hi DiffText guifg=#f63ba4 guibg=NONE
hi ErrorMsg guifg=#f63ba4 guibg=NONE
hi WarningMsg guifg=#f63ba4 guibg=NONE
hi PreProc guifg=#f63ba4 guibg=NONE
hi Exception guifg=#f63ba4 guibg=NONE
hi Error guifg=#f63ba4 guibg=NONE
hi DiffDelete guifg=#f63ba4 guibg=NONE
hi GitGutterDelete guifg=#f63ba4 guibg=NONE
hi GitGutterChangeDelete guifg=#f63ba4 guibg=NONE
hi cssIdentifier guifg=#f63ba4 guibg=NONE
hi cssImportant guifg=#f63ba4 guibg=NONE
hi Type guifg=#f63ba4 guibg=NONE
hi Identifier guifg=#f63ba4 guibg=NONE
hi PMenuSel guifg=#61f8b9 guibg=NONE
hi Constant guifg=#61f8b9 guibg=NONE
hi Repeat guifg=#61f8b9 guibg=NONE
hi DiffAdd guifg=#61f8b9 guibg=NONE
hi GitGutterAdd guifg=#61f8b9 guibg=NONE
hi cssIncludeKeyword guifg=#61f8b9 guibg=NONE
hi Keyword guifg=#61f8b9 guibg=NONE
